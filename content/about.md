...
Over time, this has naturally expanded into building systems beyond simulation — including tooling, automation pipelines, and more recently, AI systems that can reason about code and engineering workflows.  
...
- Design **simulation frameworks and tools** for engineering workflows  
- Develop **AI-assisted systems** for debugging, reasoning, and automation  
- Explore connections between **physics-based modeling and AI reasoning**  
